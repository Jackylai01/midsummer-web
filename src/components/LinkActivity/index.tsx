    ...
    <header id='link-activity' className='link'>
      <main className='link__container'>
        ...
        <footer className='link__items'>
          ...
          <span
            className={`link__items--item link__items--item-default  ${
              selectedRegion === '中部地區' ? 'link__items--item-1' : ''
            }`}
          ...
          <span
            className={`link__items--item link__items--item-default ${
              selectedRegion === '南部地區' ? ' link__items--item-1' : ''
            }`}
          ...
          <span
            className={`link__items--item link__items--item-default ${
              selectedRegion === '東部地區' ? ' link__items--item-1' : ''
            }`}
          ...
          <span
            className={`link__items--item link__items--item-default ${
              selectedRegion === '離島地區' ? ' link__items--item-1' : ''
            }`}
